...
const AdminPage = ({ get }) => {
  ...
  const [selectedStaff, setSelectedStaff] = useState({ designation: [] });
  const [newStaff, setNewStaff] = useState({ designation: [] });

  // const [selectedStaff, setSelectedStaff] = useState(null);
  // const [newStaff, setNewStaff] = useState({ regno: '', name: '', email: '', dept: '', designation: [], password: '',phone_no:'' ,tutor:''});
    ...
    <div className="outer-container-incharge">
      <div className="admin-page">
        ...
        <div className="admin-file-upload">
          ...
          <Button className="admin-submit-btn" onClick={() => get()}>
            Submit
          </Button>
        </div>
              ...
              <tr key={staff.regno}>
                ...
                <td>
                  ...
                  <Button
                    class="admin-btn"
                    variant="danger"
                    onClick={() => handleDeleteStaff(staff.regno)}
                  >
                    Delete
                  </Button>
                </td>
            ...
            <Form>
              ...
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  value={
                    selectedStaff ? selectedStaff.phone_no : newStaff.phone_no
                  }
                  onChange={(e) =>
                    selectedStaff
                      ? setSelectedStaff({
              ...
              <Form.Group>
                ...
                {["Incharge", "Tutor"].map((designation) => (
                  <Form.Check
                    key={designation}
                    type="checkbox"
                    label={
                      designation === "Incharge" ? "Nptel Incharge" : "Tutor"
                    }
                    checked={
                      selectedStaff
                        ? Array.isArray(selectedStaff.designation) &&
                          selectedStaff.designation.includes(designation)
                        : Array.isArray(newStaff.designation) &&
                          newStaff.designation.includes(designation)
                    }
                    onChange={(e) => {
                      ...
                      if (selectedStaff) {
                        setSelectedStaff((prev) => ({
                          ...prev,
                          designation: isChecked
                            ? [
                                ...(Array.isArray(prev.designation)
                                  ? prev.designation
                                  : []),
                                designation,
                              ] // ✅ Always an array
                ...
                {/* Show batch input if TUTOR is selected */}
                {(selectedStaff
                  ? selectedStaff.designation.includes("Tutor")
                  : newStaff.designation.includes("Tutor")) && (
                  <Form.Group controlId="tutorBatch">
                    <Form.Label>Enter Tutor's Batch</Form.Label>
                    <Form.Control
                      type="text"
                      ...
                      onChange={(e) => {
                        if (selectedStaff) {
                          ...
                          setNewStaff({ ...newStaff, tutor: e.target.value });
                        }
                      }}
                    />
                  </Form.Group>
              ...
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  value={
                    selectedStaff ? selectedStaff.password : newStaff.password
                  }
                  onChange={(e) =>
                    selectedStaff
                      ? setSelectedStaff({
